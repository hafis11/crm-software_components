                    ...
                    <div class="box1 col-md-6">
                        ...
                        <div class="producttab h-auto mt-5">
                            ...
                            <div class="d-flex  p-2 align-items-center">
                                ...
                                <input class="unit-adder col-1 ml-5  mr-4 form-control bg-light border-0" type="text" placeholder="Qty" onChange={event => this.setState({ unit: event.target.value })}></input>
